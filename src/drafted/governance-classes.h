 ...
 *
 *   // network
 *   CAlarmxNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.alarmx.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAlarmxNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AlarmxNetwork
// //   -- signature requirements : Key1(User)
// class CAlarmxNetworkVariable : public CGovernanceObject
// {
// private:
