...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AlarmxNetwork") type = AlarmxNetwork;
    if(strType == "AlarmxNetworkVariable") type = AlarmxNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AlarmxNetwork) s = "AlarmxNetwork";
    if(type == AlarmxNetworkVariable) s = "AlarmxNetworkVariable";
