...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Alarmx related functionality
...
/*
    ...
    allow endless transaction that would bloat Alarmx and make it unusable. To
