...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Alarmx Core alarmx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  alarmx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded alarmx transaction") + "\n" +
              "  alarmx-tx [options] -create [commands]   " + _("Create hex-encoded alarmx transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded alarmx transaction
