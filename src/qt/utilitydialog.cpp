    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("AlarmX Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About AlarmX Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  alarmx-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Alarmx in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ALRMX, 0.1 ALRMX, 1 ALRMX and 10 ALRMX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://alarmxcore.atlassian.net/wiki/display/DOC/PrivateSend\">https://alarmxcore.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("AlarmX Core is shutting down...") + "<br /><br />" +
