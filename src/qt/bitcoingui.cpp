    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("AlarmX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Alarmx address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and alarmx: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About AlarmX Core"), this);
    aboutAction->setStatusTip(tr("Show information about AlarmX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AlarmX Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Alarmx addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Alarmx addresses"));
    ...
    openAction->setStatusTip(tr("Open a alarmx: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AlarmX Core help message to get a list with possible AlarmX Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("AlarmX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Alarmx network", "", count));
    } else {
...
{
    QString strTitle = tr("AlarmX Core"); // default title
