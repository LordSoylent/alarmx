...
#define BOOST_TEST_MODULE Alarmx Test Suite

#include "test_alarmx.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_alarmx_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
