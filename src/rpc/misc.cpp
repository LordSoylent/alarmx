...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total alarmx balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized alarmx balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "alarmx|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "alarmx")
            + HelpExampleRpc("debug", "alarmx,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"alarmxaddress\"\n"
            "\nReturn information about the given alarmx address.\n"
            "\nArguments:\n"
            "1. \"alarmxaddress\"     (string, required) The alarmx address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"alarmxaddress\", (string) The alarmx address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"")
            + HelpExampleRpc("validateaddress", "\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: Alarmx address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are alarmx addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) alarmx address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"alarmxaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"alarmxaddress\"  (string, required) The alarmx address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"AT2wMEpLDjf3wkACg97fGyEK9qqmCMiwTJ\"]}")
        );
