...
Only requiring some minor changes is alarmx.cpp.
...
Changes to alarmx.cpp
----------------------
alarmx.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
