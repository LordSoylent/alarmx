...
This mechanism has been integrated into Bitcore-Node-Alarmx which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/alarmxcore/insight-api-alarmx#web-socket-api](https://github.com/alarmxcore/insight-api-alarmx#web-socket-api)
* API: [https://github.com/alarmxcore/insight-api-alarmx#instantsend-transactions](https://github.com/alarmxcore/insight-api-alarmx#instantsend-transactions)
...
By default, the Alarmx Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Alarmx Core daemon:
